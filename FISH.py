...
if __name__ == '__main__':
    ...
    # ---------------------------- log and train ------------------------------------
    log_file = open(config.model_name+'_'+config.dataset+'_'+str(config.code_length)+'.log', 'a')
    log_file.write(str(config))
    log_file.write('\n')
    print('training start ...')
    train_model(model, dataloader, criterion, criterion_hash, optimizer, exp_lr_scheduler, config.epoch, config.code_length, classes, log_file)
    log_file.close()
